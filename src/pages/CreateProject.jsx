...
const CreateProject = ({ token }) => {
 ...
 <form onSubmit={handleSubmit}>
      <section class="shadow-blue-100 mx-auto max-w-screen-lg rounded-xl bg-white text-gray-600 shadow-lg sm:my-10 sm:border">
        <div class="container mx-auto flex flex-col flex-wrap px-5 pb-2 m-8">
          <div class="flex w-full flex-col">
            ...
            Add project details and manage project by discussing them with your team members
            </p>
            <div class="mt-4 mb-6 grid items-center gap-3 gap-y-5 sm:grid-cols-4">
  <div class="flex flex-col sm:col-span-3">
    <label class="mb-1 ml-3 font-semibold text-gray-500" for="breakfast">
      Project Name
    </label>
    <input
      type="text"
  ...
  <div class="col-span-1 flex flex-col">
    <label class="mb-1 ml-3 font-semibold text-gray-500" for="drink1">
      Add first Member ID
    </label>
    <input
      type="text"
  ...
  <div class="flex flex-col sm:col-span-3">
    <label class="mb-1 ml-3 font-semibold text-gray-500" for="lunch">
      Project Description
    </label>
    <input
      type="text"
  ...
  <div class="col-span-1 flex flex-col">
    <label class="mb-1 ml-3 font-semibold text-gray-500" for="drink2">
  ...
  <div class="flex flex-col sm:col-span-3">
    <label class="mb-1 ml-3 font-semibold text-gray-500" for="dinner">
      Due Date
    </label>
    <input
      type="date"
  ...
  <div class="col-span-1 flex flex-col">
    ...
    />
            ...
            <div class="flex flex-col justify-between sm:flex-row">
              ...
              <Link to='/dashboard' class="group order-1 my-2 flex w-full items-center justify-center rounded-lg bg-gray-200 py-2 text-center font-bold text-gray-600 outline-none transition sm:w-40 focus:ring hover:bg-gray-300">
                Back to HomePage
              </Link>
